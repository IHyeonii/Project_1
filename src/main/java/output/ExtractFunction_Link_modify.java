  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      for (String key : duplicateLink.keySet()) {
        ...
        ArrayList<Object> arr = linkInfo.get(link1);
        ...
        ArrayList<Object> arr1 = linkInfo.get(link2);
        LineString ls2 = (LineString) arr1.get(4); // 형상
        long link2snode = (long) arr1.get(2);
        long link2enode = (long) arr1.get(3);
...
//      exportNodeShp(ret, linkCoors, linkInfo);
  ...
  static void exportNodeShp(ArrayList<SimpleFeature> ret, ArrayList<Coordinate[]> linkCoors, Map<Long, ArrayList<Object>> linkInfo) throws Exception { // 여긴 받을 준비
    ...
    for (SimpleFeature originalLink : ret) {
      ...
      Integer stndid = (Integer) originalLink.getAttribute("fromNode");
      Integer edndid = (Integer) originalLink.getAttribute("toNode");
    ...
    while (iterator.hasNext()) {
      ...
      Set<Map.Entry<Long, ArrayList<Object>>> entries1 = linkInfo.entrySet();

      for (Map.Entry<Long, ArrayList<Object>> arr : entries1) {
        SimpleFeature value = (SimpleFeature) arr.getValue(); // ClassCastException
